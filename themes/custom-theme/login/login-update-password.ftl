        ...
        <div class="w-full max-w-md animate-fade-in-up">
            <div class="bg-[#1a1f2e] backdrop-blur-xl rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-[#2d3548] p-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-slate-400">Defina sua nova senha</p>
                </div>
                ...
                <form id="kc-passwd-update-form" action="${url.loginAction}" method="post" class="space-y-5">
                    ...
                    <div>
                        <label for="password-new" class="block text-sm font-semibold text-slate-300 mb-2">${msg("passwordNew")}</label>
                        <input 
                            type="password" 
                            id="password-new" 
                            name="password-new"
                    ...
                    <#if isAppInitiatedAction??>
                        <div class="flex gap-4 pt-4">
                            ...
                            <button 
                                ...
                                name="cancel-aia" 
                                value="true"
                                class="flex-1 py-3 px-4 bg-[#0f1419] border border-[#2d3548] text-slate-300 font-semibold rounded-lg hover:bg-[#1a1f2e] transition-all"
                            >
                                ${msg("doCancel")}
                            </button>
                        </div>
                    <#else>
                        <button 
                            type="submit"
                            class="w-full py-3 px-4 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200"
                        >
                            ${msg("doSubmit")}
                        </button>
                    </#if>
